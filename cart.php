     ...
     <div class="container">
         <div class="row">
             <div class="col d-flex justify-content-end mb-2">
                 <button class="btn theme-btn" type="button" id="empty_cart">Empty Cart</button>
             </div>
         </div>
             ...
             <div class="card-body">
                    ...
                    ?>
                     <div class="d-flex w-100 justify-content-between  mb-2 py-2 border-bottom cart-item">
                         <div class="d-flex align-items-center col-8">
                             ...
                             <div>
                                 <h2 class="mb-1 mb-sm-1"><?php echo $row['name'] ?></h2>
                                 <h4 class="text-muted"><?php echo ($row['variant']) ?></h4><br>
                                 <h3 class="mb-1 mb-sm-1"><small><b>Price:</b> <span class="price"><?php echo format_num($row['price']) ?></span></small></h3>
                                 <div>
                 ...
                 <div class="d-flex w-100 justify-content-between mb-2 py-2 border-bottom">
                     ...
                     <div class="col d-flex justify-content-end">
                         <h4><?php echo format_num($delivery_fee); ?></h4>
                     </div>
                 </div>
                 <div class="d-flex w-100 justify-content-between mb-2 py-2 border-bottom">
                     <div class="col-8 d-flex justify-content-end">
         ...
         <div class="d-flex w-100 justify-content-end">
             <a href="./?p=checkout" class="btn theme-btn">Checkout</a>
         </div>
     </div>
 </section>
 <script>
