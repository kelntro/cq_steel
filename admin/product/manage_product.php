	...
	<div class="card-body">
		<form action="" id="product-form">
            ...
            <div class="form-group">
				<label for="brand_id" class="control-label">Roof Type</label>
                <select name="brand_id" id="brand_id" class="custom-select select2" required>
                <option value=""></option>
                <?php
                    $qry = $conn->query("SELECT * FROM `type` where delete_flag = 0 ".(isset($brand_id) ? " or id = '{$brand_id}' ": "")." order by `name` asc");
